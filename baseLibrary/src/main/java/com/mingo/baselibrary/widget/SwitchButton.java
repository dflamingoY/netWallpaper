...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        enableEffect = optBoolean(typedArray,
                ...
                true);
        checkButtonStrokeColor = optColor(typedArray,
                R.styleable.SwitchButton_sb_button_stroke_color,
                0xffDDDDDD);
        if (typedArray != null) {
            typedArray.recycle();
        }
    ...
    private void drawButton(Canvas canvas, float x, float y) {
        ...
        paint.setStyle(Paint.Style.STROKE);
        paint.setStrokeWidth(1);
        //        paint.setColor(0XffDDDDDD);0Xff404054
        paint.setColor(checkButtonStrokeColor);
    ...
    public void setSb_checked(boolean isChecked) {
     ...
     * 按钮的圆形边框的颜色
     */
    private int checkButtonStrokeColor;
